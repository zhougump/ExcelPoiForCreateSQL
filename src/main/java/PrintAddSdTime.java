...
public class PrintAddSdTime {
    public static void printToTxt(String path0,String path1) throws IOException {
        ...
        for (int i = 0, n; i < list.size(); i = i + m) {
            ...
            String str1 = "`send_time` datetime,\n" +
                    "\n `tongid` bigint(20) UNSIGNED NOT NULL,\n" +
            ...
            String str2 = "PRIMARY KEY (`tongid`," + keyVar + ") USING BTREE,\n"
                    ...
                    + ") ENGINE = InnoDB  CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '" + list.get(i).getCtablename() + "' ROW_FORMAT = Dynamic;\n\n\n";
