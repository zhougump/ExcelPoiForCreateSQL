...
public class PringToSql {
    public static void print(String path1, String path2) throws IOException {
        ...
        for (int i=0;i<list.size();i++){
            ...
            String sql = "insert into `t_universal_form_citizen_register_kp_jt` (`FULL_NAME`,`GENDER`,`AGE`,`CERT_TYPE`,`RESIDENCE_TYPE`," +
                    ...
                    "\",\"" + pojo.getC26() + "\",\"" + pojo.getC27() + "\",\"" + pojo.getC28() + "\",\"" + pojo.getC29() + "\");\n" ;
